        ...
        <Box component="main" sx={{ flexGrow: 1, p: 3, paddingTop: "100px" }}>
          <Grid container spacing={3}>
            <Grid item xs={12} md={12}>
              <Card>
                <CardHeader
                  title="Tournafest Organizers"
                  titleTypographyProps={{ variant: "h6" }}
                />
                <CardContent>
                  <Typography variant="body2">
                    There are currently {organizerCount} Organizers registered
                    on Tournafest.
                  </Typography>
                </CardContent>
              </Card>
            ...
            <Grid item xs={12}>
              <Typography variant="h4">Tournafest Organizers</Typography>
              {/* Pass the 'rows' data here */}
              <TableCustomized
                data={rows}
                searchUsername={searchUsername}
                banFilter={banFilter}
                url="http://localhost:8000/user/organizers"
              />
            </Grid>
          </Grid>
        </Box>
